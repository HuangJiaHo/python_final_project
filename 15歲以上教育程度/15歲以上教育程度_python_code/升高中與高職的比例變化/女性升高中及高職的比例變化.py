...
Senior_high_compare = Senior_high_compare.drop(["按年月別分_Year_and_month", "總計_Total","男_Male", "女_Female",
...
Senior_high_compare.plot(ylim=(0,4000), fontsize=15)
plt.xticks(np.arange(0, 42, step = 2), year_af_1978_xticks)
plt.yticks(np.arange(0,4500, step = 500))
plt.title("女性升高中職的比例變化 1978年 ~ 2019年", fontsize=50)
