...
Senior_high_compare_MF = bf_2019_data.drop(["按年月別分_Year_and_month", "總計_Total","男_Male", "女_Female",
...
#------Save_to_csv-------#
Senior_high_compare_MF.to_csv('C:\\Users\\IRVING\\Desktop\\python_final_project\\15歲以上教育程度\\15歲以上教育程度_process_csv\\升高中與高職的比例變化\\男女升高中及高職的比例變化\\Senior_high_compare_MF_2014_2019.csv')
#------------------------#


#------Show_all_img------#
Senior_high_compare_MF.plot.bar(ylim=(0,5000), fontsize=15)
plt.title("男女升高中職的比例 會考 2014年 ~ 2019年", fontsize=50)
