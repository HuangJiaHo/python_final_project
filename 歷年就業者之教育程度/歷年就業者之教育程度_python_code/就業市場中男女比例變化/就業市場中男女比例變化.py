...
Senior_high_compare = Senior_high_compare.drop(["按年月別分_Year_and_month",
...
Senior_high_compare.plot(ylim=(0,13000), fontsize=15)
plt.xticks(np.arange(0, 42, step = 2), year_af_1978_xticks)
plt.yticks(np.arange(0, 14000, step = 1000))
