...
bf_2013_data = bf_2013_data.set_index(bf_2013_data["按年月別分_Year_and_month"])
Senior_high_compare_MF = bf_2013_data.drop(["按年月別分_Year_and_month", "總計_Total","男_Male", "女_Female",
...
#------Save_to_csv-------#
bf_2013_data.to_csv('C:\\Users\\IRVING\\Desktop\\python_final_project\\15歲以上教育程度\\15歲以上教育程度_process_csv\\升高中與高職的比例變化\\男女升高中及高職的比例變化\\Senior_high_compare_MF_2001_2013.csv')
#------------------------#


#------Show_all_img------#
Senior_high_compare_MF.plot.bar(ylim=(0,5000), fontsize=15)
plt.title("男女升高中職的比例 基測 2001年 ~ 2013年", fontsize=50)
plt.legend(loc='upper left', fontsize=13.5)
plt.xlabel('年度', fontsize=25)
plt.ylabel('人數', fontsize=25)
plt.yticks(np.arange(0,5500, step = 500))
plt.show()
#------------------------#