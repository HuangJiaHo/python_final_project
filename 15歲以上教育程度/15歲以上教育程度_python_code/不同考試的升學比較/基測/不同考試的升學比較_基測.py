...
bf_2013_data = bf_2013_data.drop(["按年月別分_Year_and_month", "男_Male", "女_Female",                                  
...
#-----Reload_csv_file----#
data = pd.read_csv('C:\\Users\\IRVING\\Desktop\\python_final_project\\15歲以上教育程度\\15歲以上教育程度_process_csv\\不同考試的升學比較\\bf_2013.csv')
bf_2013_data = pd.DataFrame(data)
bf_2013_data = bf_2013_data.set_index(bf_2013_data["按年月別分_Year_and_month"])
bf_2013_data = bf_2013_data.drop(["按年月別分_Year_and_month"], axis=1)
#------------------------#
...
plt.yticks(np.arange(0,32000, step = 2000))
plt.show()
#------------------------#
