...
try:
    Senior_high_compare['男生佔高職比率'] = Senior_high_compare['男生佔高職比率'].map(lambda x: str(x)[:-1])
    Senior_high_compare['女生佔高職比率'] = Senior_high_compare['女生佔高職比率'].map(lambda x: str(x)[:-1])
...
plt.title("男女占高職比例 1978年 ~ 2019年", fontsize=50)
