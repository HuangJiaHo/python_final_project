...
Senior_high_compare = Senior_high_compare.drop(["年份",
                                                ...
                                                "女生佔高職比率"], axis=1)
try:
    Senior_high_compare['男生佔高中職比率'] = Senior_high_compare['男生佔高中職比率'].map(lambda x: str(x)[:-1])
    Senior_high_compare['女生佔高中職比率'] = Senior_high_compare['女生佔高中職比率'].map(lambda x: str(x)[:-1])
...
plt.title("男女占高中職總比例 1978年 ~ 2019年", fontsize=50)
