...
#------Save_to_csv-------#
Senior_high_compare.to_csv('C:\\Users\\IRVING\\Desktop\\python_final_project\\15歲以上教育程度\\15歲以上教育程度_process_csv\\不同考試的升學比較\\不同考試的升學比較.csv')
#------------------------#


#-----Reload_csv_file----#
data = pd.read_csv('C:\\Users\\IRVING\\Desktop\\python_final_project\\15歲以上教育程度\\15歲以上教育程度_process_csv\\不同考試的升學比較\\不同考試的升學比較.csv')
