...
#Senior_high_compare_MF = Senior_high_compare_MF.set_index(Senior_high_compare_MF["按年月別分_Year_and_month"])
Senior_high_compare_MF = Senior_high_compare_MF.drop([
                                                      "按年月別分_Year_and_month",
                                                      "總計_Total","男_Male",
                                                      "女_Female",
...
plt.title("男女升高中職的總比例 1978年 ~ 2019年", fontsize=50)
